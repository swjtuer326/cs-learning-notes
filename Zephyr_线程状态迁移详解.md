...
> 📖 **返回**：[学习文档导航](./README.md) | [入门概览](./Zephyr_RTOS_学习笔记.md) | [核心数据结构](./Zephyr_核心数据结构设计详解.md)
...
Zephyr 使用**位标志**表示线程状态，定义于 [include/zephyr/kernel_structs.h](file:///home/pbw/rtos/zephyr/include/zephyr/kernel_structs.h#L52)：
