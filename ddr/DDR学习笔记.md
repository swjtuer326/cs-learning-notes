...
> **⚠️ 本文档已拆分为 8 个子文档，请以拆分后的文档为准。**
>
> 拆分后的文档按学习顺序排列，内容更聚焦、结构更清晰：
>
> | 序号 | 文档 | 内容概要 |
> |:----:|------|---------|
> | 01 | [DDR 基础概念](./01-DDR基础概念.md) | DDR 概述、发展历程、系统架构、总线信号、存储阵列 |
> | 02 | [DDR 物理结构与硬件设计](./02-DDR物理结构与硬件设计.md) | 颗粒/Rank/Bank 详解、PCB 布局、ECC、ODT |
> | 03 | [DDR 工作原理与时序参数](./03-DDR工作原理与时序参数.md) | 初始化/读写操作、刷新机制、功耗模式、时序参数详解 |
> | 04 | [DDR 控制器、PHY 与训练](./04-DDR控制器PHY与训练.md) | 控制器架构、PHY 设计、训练流程 |
> | 05 | [DDR 驱动开发与调试](./05-DDR驱动开发与调试.md) | U-Boot 初始化、设备树、内存测试、故障排查 |
> | 06 | [DDR 性能优化与测量调试](./06-DDR性能优化与测量调试.md) | 带宽计算、地址映射、调度策略、信号完整性、案例分析 |
> | 07 | [DDR 新技术与学习资源](./07-DDR新技术与学习资源.md) | DDR5/HBM/GDDR 新特性、JEDEC 标准、参考书籍 |
> | 08 | [DDR 附录与参考资料](./08-DDR附录与参考资料.md) | 术语表、频率对照表、寄存器速查 |
>
> 本文档保留作为历史参考，**不再维护更新**。如有内容疑问，请以拆分后的子文档为准。
