...
串扰类型：近端串扰（NEXT，在攻击线驱动端产生）和远端串扰（FEXT，在攻击线接收端产生）。

减小串扰的方法：

| 方法 | 说明 |
|------|------|
| 增加线间距 | 3W 原则：线间距 ≥ 3 倍线宽 |
| 地线隔离 | 在信号线之间插入地线 |
| 差分对布线 | 正负信号紧密耦合 |
| 交错走线 | 不同层走线方向垂直 |
| 控制边沿速率 | 减缓上升/下降时间 |
...
> DDR 训练的核心目标就是"张开眼图"——最大化信号的眼图开口，确保数据采样的时序和电压裕量充足。
...
> 导航链接：
> - [上一篇：DDR驱动开发与调试](./05-DDR驱动开发与调试.md) | [下一篇：DDR新技术与学习资源](./07-DDR新技术与学习资源.md)
