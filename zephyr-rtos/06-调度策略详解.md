...
- [Zephyr 官方调度文档](../zephyr-project/zephyr/doc/kernel/services/scheduling/index.rst) — 参考了 §"Scheduling"、§"Preemptive Time Slicing"、§"Scheduler Locking"、§"CPU Idle"
- [Zephyr 官方 SMP 文档](../zephyr-project/zephyr/doc/kernel/services/smp/smp.rst) — 参考了 §"SMP Support"、§"CPU Masks"、§"Interprocessor Interrupts"
