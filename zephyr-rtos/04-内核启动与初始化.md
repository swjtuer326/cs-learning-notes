...
- [Zephyr 驱动模型官方文档](../zephyr-project/zephyr/doc/kernel/drivers/index.rst) — 参考了 §"Initialization Levels"、§"Deferred initialization"、§"System Drivers"
- [kernel/init.c](file:///home/pbw/rtos/cs-learning-notes/zephyr-project/zephyr/kernel/init.c) — 内核初始化主流程源码，重点关注 `z_cstart()`、`bg_thread_main()`、`z_sys_init_run_level()`
- [include/zephyr/init.h](file:///home/pbw/rtos/cs-learning-notes/zephyr-project/zephyr/include/zephyr/init.h) — 初始化级别与 `SYS_INIT` 宏定义，重点关注 `EARLY`/`PRE_KERNEL_1`/`PRE_KERNEL_2`/`POST_KERNEL`/`APPLICATION`/`SMP` 枚举
- [include/zephyr/device.h](file:///home/pbw/rtos/cs-learning-notes/zephyr-project/zephyr/include/zephyr/device.h) — `DEVICE_DEFINE` / `DEVICE_DT_DEFINE` 宏定义，重点关注 `z_init_callback` 与 `Z_DEVICE_INIT_ENTRY` 宏
...
- [include/zephyr/linker/common-rom/common-rom-kernel-devices.ld](file:///home/pbw/rtos/cs-learning-notes/zephyr-project/zephyr/include/zephyr/linker/common-rom/common-rom-kernel-devices.ld) — init 段链接脚本，重点关注 `.z_init_*` 段定义
- [include/zephyr/linker/linker-defs.h](file:///home/pbw/rtos/cs-learning-notes/zephyr-project/zephyr/include/zephyr/linker/linker-defs.h) — `CREATE_OBJ_LEVEL` 宏，按 init 级别构造段名
- [arch/arm/core/cortex_m/reset.S](file:///home/pbw/rtos/cs-learning-notes/zephyr-project/zephyr/arch/arm/core/cortex_m/reset.S) — Cortex-M 复位汇编入口 `z_arm_reset`
- [arch/arm/core/cortex_m/prep_c.c](file:///home/pbw/rtos/cs-learning-notes/zephyr-project/zephyr/arch/arm/core/cortex_m/prep_c.c) — Cortex-M C 准备阶段 `z_prep_c()`
- [arch/arm/core/cortex_m/vector_table.S](file:///home/pbw/rtos/cs-learning-notes/zephyr-project/zephyr/arch/arm/core/cortex_m/vector_table.S) — Cortex-M 异常向量表 `_vector_table`
- [Zephyr Kernel Startup Guide](https://docs.zephyrproject.org/latest/kernel/other/startup.html) — 官方启动流程说明，参考 §"Kernel Initialization Sequence"
