...
[`kernel/sem.c`](file:///home/pbw/rtos/cs-learning-notes/zephyr-project/zephyr/kernel/sem.c#L45-L73) — 设置初始计数与上限，初始化等待队列：
...
[`kernel/sem.c`](file:///home/pbw/rtos/cs-learning-notes/zephyr-project/zephyr/kernel/sem.c#L132-L164) — 三条路径：直接获取、不等待返回、阻塞：
...
[`kernel/sem.c`](file:///home/pbw/rtos/cs-learning-notes/zephyr-project/zephyr/kernel/sem.c#L95-L121) — 优先唤醒等待者，否则增加计数：
...
[`kernel/mutex.c`](file:///home/pbw/rtos/cs-learning-notes/zephyr-project/zephyr/kernel/mutex.c#L107-L218) 简化版（聚焦 PI 路径）：
...
[`kernel/condvar.c`](file:///home/pbw/rtos/cs-learning-notes/zephyr-project/zephyr/kernel/condvar.c#L44-L65) — `signal` 唤醒一个等待者：
...
`broadcast` 类似但循环唤醒所有等待者（[`kernel/condvar.c`](file:///home/pbw/rtos/cs-learning-notes/zephyr-project/zephyr/kernel/condvar.c#L76-L104)）。
