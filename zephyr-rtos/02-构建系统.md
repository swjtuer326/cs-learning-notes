...
- [West basics](../zephyr-project/zephyr/doc/develop/west/basics.rst) — 参考了 §"West Workspaces"、§"The West Manifest"、§"Built-in Commands"
- [West workspaces](../zephyr-project/zephyr/doc/develop/west/workspaces.rst) — 参考了 §"T1/T2/T3 workspace topologies"、§"The manifest-rev branch"
- [West manifest](../zephyr-project/zephyr/doc/develop/west/manifest.rst) — 参考了 §"Manifest file syntax"、§"Manifest imports"、§"Project groups"
- [West built-in commands](../zephyr-project/zephyr/doc/develop/west/built-in.rst) — 参考了 §"west init"、§"west update"、§"west list"
- [West build/flash/debug](../zephyr-project/zephyr/doc/develop/west/build-flash-debug.rst) — 参考了 §"west build"、§"west flash"、§"west debug"
- [West Zephyr extension commands](../zephyr-project/zephyr/doc/develop/west/zephyr-cmds.rst) — 参考了 §"west boards"、§"west sdk"
- [CMake build system](../zephyr-project/zephyr/doc/build/cmake/index.rst) — 参考了 §"Build stages"、§"Build system targets"、§"Application CMakeLists"
- [Kconfig configuration system](../zephyr-project/zephyr/doc/build/kconfig/index.rst) — 参考了 §"Kconfig language"、§"Configuration file selection"
- [Setting Kconfig values](../zephyr-project/zephyr/doc/build/kconfig/setting.rst) — 参考了 §"Configuration file precedence"、§"The .config file"
- [Kconfig extensions](../zephyr-project/zephyr/doc/build/kconfig/extensions.rst) — 参考了 §"Kconfig preprocessor functions"、§"Kconfig hints"
- [Snippets](../zephyr-project/zephyr/doc/build/snippets/index.rst) — 参考了 §"Using snippets"、§"Designing snippets"
- [Sysbuild](../zephyr-project/zephyr/doc/build/sysbuild/index.rst) — 参考了 §"What is sysbuild?"、§"Sysbuild targets"、§"Images and domains"
- [Zephyr 源码 west.yml](file:///home/pbw/rtos/cs-learning-notes/zephyr-project/zephyr/west.yml) — 上游 manifest 实例，重点关注 `manifest.projects` 与 `manifest.group-filter`
- [Zephyr 源码 CMakeLists.txt](file:///home/pbw/rtos/cs-learning-notes/zephyr-project/zephyr/CMakeLists.txt) — 多趟链接定义，重点关注 `zephyr_pre0`/`zephyr_pre1`/`zephyr_final` 目标
