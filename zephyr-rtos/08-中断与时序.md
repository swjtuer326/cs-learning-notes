...
- [Interrupts](../zephyr-project/zephyr/doc/kernel/services/interrupts.rst) — 参考了 §"Concepts"、§"Defining regular ISRs"、§"Defining direct ISRs"、§"Zero Latency Interrupts"
- [Polling API](../zephyr-project/zephyr/doc/kernel/services/polling.rst) — 参考了 §"Concepts"、§"API"、§"Implementation"
- [Kernel Timing - Clocks](../zephyr-project/zephyr/doc/kernel/services/timing/clocks.rst) — 参考了 §"Clocks"、§"Time Units"、§"Uptime"
- [Kernel Timing - Timers](../zephyr-project/zephyr/doc/kernel/services/timing/timers.rst) — 参考了 §"Concepts"、§"API"、§"Implementation"
- [Executing Time Functions](../zephyr-project/zephyr/doc/kernel/timing_functions/index.rst) — 参考了 §"Timing Functions"
- [Time Utilities](../zephyr-project/zephyr/doc/kernel/timeutil.rst) — 参考了 §"Time Utilities"
