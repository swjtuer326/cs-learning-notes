...
- [Devicetree Introduction](../zephyr-project/zephyr/doc/build/dts/intro.rst) — 参考了 §"What is Devicetree?"、§"Devicetree in Zephyr"
- [Devicetree Scope and Purpose](../zephyr-project/zephyr/doc/build/dts/intro-scope-purpose.rst) — 参考了 §"Devicetree versus Kconfig"、§"Build-time and run-time"
- [Devicetree Syntax and Structure](../zephyr-project/zephyr/doc/build/dts/intro-syntax-structure.rst) — 参考了 §"Nodes"、§"Properties"、§"Aliases and chosen nodes"
- [Devicetree Input and Output Files](../zephyr-project/zephyr/doc/build/dts/intro-input-output.rst) — 参考了 §"Input files"、§"Output files"、§"Generated C header"
- [Devicetree Bindings](../zephyr-project/zephyr/doc/build/dts/bindings.rst) — 参考了 §"What are bindings?"、§"Bindings search paths"
- [Devicetree Bindings Syntax](../zephyr-project/zephyr/doc/build/dts/bindings-syntax.rst) — 参考了 §"Binding file format"、§"Property types"
- [Phandles](../zephyr-project/zephyr/doc/build/dts/phandles.rst) — 参考了 §"Phandle"、§"Phandle arrays"、§"Property specifier spaces"
- [Devicetree Access from C/C++](../zephyr-project/zephyr/doc/build/dts/api-usage.rst) — 参考了 §"Node identifiers"、§"Property access"、§"Instance numbers"
- [Devicetree HOWTOs](../zephyr-project/zephyr/doc/build/dts/howtos.rst) — 参考了 §"Set devicetree overlays"、§"Get a struct device"
- [Devicetree vs Kconfig](../zephyr-project/zephyr/doc/build/dts/dt-vs-kconfig.rst) — 参考了 §"Hardware description vs configuration"
- [The /zephyr,user Node](../zephyr-project/zephyr/doc/build/dts/zephyr-user-node.rst) — 参考了 §"Node content"
- [Troubleshooting Devicetree](../zephyr-project/zephyr/doc/build/dts/troubleshooting.rst) — 参考了 §"Troubleshooting tools"、§"Common errors"
- [Devicetree Specification](https://www.devicetree.org/specifications/) — 参考了 §"Device Tree Source Format"、§"Device Tree Blob Format"
- [gen_defines.py 源码](file:///home/pbw/rtos/cs-learning-notes/zephyr-project/zephyr/scripts/dts/gen_defines.py) — C 宏生成脚本，重点看 `write_chosen()`、`write_property()` 函数
- [dts/bindings 目录](file:///home/pbw/rtos/cs-learning-notes/zephyr-project/zephyr/dts/bindings) — Zephyr 内置 Bindings 索引
