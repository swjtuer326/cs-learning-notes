...
from .src import generate_details, generate_divided_details
from .src import generate_layer
from .src import set_details_style, set_summary_style, set_layer_style, set_sim_summary_style
from .src import generate_summary
from .src import GlobalProfileParser
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="The number of cores, if bm1684x set 1, set 2 for A2, set 4 for AKSV, set 8 for AKS.",
    )
    parser.add_argument(
        "--output",
        type=str,
