...
# time: 2026-06-29 10:43:23
# chip: AKS
# source files: refer/aks/SG2260_TPU_TIU_Reg1.0.xlsx, refer/aks/GDMA_SG2260_DES_REG.xlsx, refer/aks/CDMA_2260_DES_REG_v5.1.xlsx
...
class DMA_tensor_0x000_reg(atomic_reg):
    ...
    @property
    def reserved_1(self) -> int:
        return self["reserved"]
    @property
    def reserved_2(self) -> int:
        return self["reserved"]
    @property
    def reserved_3(self) -> int:
        return self["reserved"]
    @property
    def reserved_4(self) -> int:
        return self["reserved"]
    @property
    def reserved_5(self) -> int:
        return self["reserved"]
    @property
    def reserved_6(self) -> int:
        return self["reserved"]
    @property
    def Reserved_1(self) -> int:
        return self["Reserved"]
...
class DMA_nonzero_reg(atomic_reg):
    ...
    def reserved_3(self) -> int:
        return self["reserved"]
    @property
    def dst_nstride_base_i(self) -> int:
...
class DMA_lossy_compress_reg(atomic_reg):
    ...
    def reserved_6(self) -> int:
        return self["reserved"]
    @property
    def reserved_7(self) -> int:
        return self["reserved"]
    @property
    def reserved_8(self) -> int:
        return self["reserved"]
    @property
    def reserved_9(self) -> int:
        return self["reserved"]
    @property
    def reserved_10(self) -> int:
        return self["reserved"]
    @property
    def reserved_11(self) -> int:
        return self["reserved"]
    @property
    def reserved_12(self) -> int:
        return self["reserved"]
    @property
    def reserved_13(self) -> int:
        return self["reserved"]
    @property
    def reserved_14(self) -> int:
        return self["reserved"]
    @property
    def reserved_15(self) -> int:
        return self["reserved"]
    @property
    def reserved_16(self) -> int:
        return self["reserved"]
    @property
    def reserved_17(self) -> int:
        return self["reserved"]
    @property
    def reserved_18(self) -> int:
        return self["reserved"]
...
class CDMA_read_reg(atomic_reg):
    ...
    _fields_ = [
        ...
        ("reserved", ctypes.c_uint64, 1),
        ("src_data_format", ctypes.c_uint64, 4),
        ("src_start_addr_h8", ctypes.c_uint64, 13),
        ("reserved", ctypes.c_uint64, 3),
        ("dst_start_addr_h8", ctypes.c_uint64, 13),
        ("reserved", ctypes.c_uint64, 19),
        ("src_nstride", ctypes.c_uint64, 32),
        ("src_cstride", ctypes.c_uint64, 32),
        ("src_hstride", ctypes.c_uint64, 32),
...
class CDMA_tcp_send_reg(atomic_reg):
    ...
    _fields_ = [
        ...
        ("cmd_type", ctypes.c_uint64, 4),
        ("buffer length", ctypes.c_uint64, 16),
        ("breakpoint", ctypes.c_uint64, 1),
        ("reserved", ctypes.c_uint64, 7),
        ("frame length", ctypes.c_uint64, 16),
        ("reserved", ctypes.c_uint64, 16),
        ("buffer_addr_l32", ctypes.c_uint64, 32),
        ("buffer_addr_h8", ctypes.c_uint64, 8),
...
class CDMA_tcp_receive_reg(atomic_reg):
    OP_NAME = "CDMA_tcp_receive"
    _fields_ = [
        ("intr_en", ctypes.c_uint64, 1),
        ("own", ctypes.c_uint64, 1),
        ("reserved", ctypes.c_uint64, 2),
...
op_class_dic: Dict[str, Type[atomic_reg]] = {
    ...
    "RAND": RAND_reg,
    "DMA_tensor（0x000）": DMA_tensor_0x000_reg,
    ...
    "CDMA_tcp_receive": CDMA_tcp_receive_reg,
