...
def get_target_context_cls(chip: str) -> Type[BModelContext]:
    assert chip in {"BM1684X", "BM1684", "BM1688", "AKS", "AKSV", "CV186X", "SG2380", "MARS3", "SGTPUV8"}
    ...
    elif chip in ("AKS", "AKSV"):
        from ..target.context import get_context_cls

        context = get_context_cls(chip)
    elif chip == "SG2380":
