...
┌────────┬──────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬───┬───┬───┬───┬───┬───┬───┐
│  ...   │ VSXL │ VTSR│ VTW │ VTVM│ VGEIN│  ... │ SPVP│ SPV │  ... │VSBE│  ... │FD │  ... │FI │  ... │FI │
└────────┴──────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴───┴───┴───┴───┴───┴───┴───┘
```
...
MODE:
  0000 = Bare（不启用第二阶段翻译）
  1000 = Sv39x4（39 位 GPA，4 级页表）
  1001 = Sv48x4（48 位 GPA，5 级页表）
  1010 = Sv57x4（57 位 GPA，6 级页表）
...
|------|----------|----------|----------------------|
| **Sv39x4** | 39 bit | 4 | 512 GB |
| **Sv48x4** | 48 bit | 5 | 256 TB |
| **Sv57x4** | 57 bit | 6 | 128 PB |
